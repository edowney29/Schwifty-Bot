 ...
 * @return string
 */
export declare function format(dateTime: TimeStruct, utcTime: TimeStruct, localZone: TimeZone | undefined | null, formatString: string, formatOptions?: PartialFormatOptions): string;
